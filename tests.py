...
commands = sl.load()
labeltext = ""
lb_text = tk.Label(joseph, text=labeltext)
lb_text.grid(row=1, column=0)

def voiceReckon():
    global labeltext, lb_text
    recognizer = Recognizer()

    with Microphone() as source:
        labeltext = "réglage du bruit ambiant...patientez..."
        lb_text = tk.Label(joseph, text=labeltext, fg="black")
